...
const Checkout = (props) => {
  ...
  const postalControlClasses = `${classes.control} ${formInputsValid.postalCode ? "" : classes.invalid}`
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={postalControlClasses}>
        ...
        {!formInputsValid.postalCode && <p>Please Enter 5 Digit Postal Code</p>}
      </div>
      <div className={cityControlClasses}>
        <label htmlFor="city">City</label>
        <input type="text" id="city" ref={cityInputRef} />
        {!formInputsValid.city && <p>Please Entere Valid City</p>}
      </div>
